...
if(NO_GIT)
  set(rev_date "2014-12-18 11:15:00 +1b3f")
  set(rev_hash "DeathCore 4.3.4")
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"DeathCore 4.3.4 2014-12-18 11:15:00 (Archived)\"")
    set(rev_date "2014-12-18 11:15:00 +1b3f")
    set(rev_hash "DeathCore 4.3.4")
    set(rev_branch "Archived")
  else()
